...
def lotsizing(T,K,A,h,v,C,f,r,b,PCE,M,betaset,alpha,pmin,pmax,dmax,TimeLimit=None):
    ...
    for t in range(1,T+1):
        ...
        m.addConstr(quicksum(f[t]*z[k,t] for k in range(1,M+1)) + r[t]*q[t] + b[t]*x[t] <= PCE)
...
if __name__ == "__main__": 
    ...
    res = lotsizing(T,K,A,h,v,C,f,r,b,PCE,M,betaset,alpha,pmin,pmax,dmax,TimeLimit=None)
    print(res)
